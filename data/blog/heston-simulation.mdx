...
The Heston model is an excellent benchmarking model due to the surprising fact that it's probability distribution function (pdf) has a closed formed expression.  It's a one
...
# BROADIEKAYAEXACTSCHEMELOBATTO, BROADIEKAYAEXACTSCHEMELAGUERRE
...
![png](/static/images/HestonSimulation_8_0.png)
...
![png](/static/images/HestonSimulation_10_1.png)
...
for k, v in processes.items():
    for step in steps:
        mc_engine = MCEuropeanHestonEngine(
            v,
            steps_per_year=step,
